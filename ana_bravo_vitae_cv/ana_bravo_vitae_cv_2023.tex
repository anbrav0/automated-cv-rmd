...
\leavevmode\vadjust pre{\hypertarget{ref-class2}{}}%
\CSLLeftMargin{1. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-sunbelt1}{}}%
\CSLLeftMargin{2. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-sunbelt2}{}}%
\CSLLeftMargin{3. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-CBPR2024}{}}%
\CSLLeftMargin{4. }%
\CSLRightInline{Bravo, A. (2024). \emph{Social network analysis: Data
collection instruments for egocentric networks}. University of Miamim
...
\leavevmode\vadjust pre{\hypertarget{ref-class1}{}}%
\CSLLeftMargin{7. }%
\CSLRightInline{Bravo, A. (2023). \emph{Interpreting data for public
health rsearch, policy, or practice}. Florida International University,
...
\item Advisor Council Board Memeber
  ...
  \end{itemize}
\end{cvitems}}
    \cventry{DSC US Health 22}{Data Science Conference 2022}{FIU Kovens Conference Center}{Oct 2022 - Oct 2022}{\begin{cvitems}
...
\item  Senior Research Assistant
  \begin{itemize}
...
\begin{cventries}
    ...
    \cventry{Member}{International Network for Social Network Analysis}{}{2024 - Present}{}\vspace{-4.0mm}
\end{cventries}
